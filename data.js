let portfolioData = {
  ...
  summary:
    "Undergraduate Computer Science student at Sri Venkateswara College of Engineering with a CGPA of 8.68 and hands-on experience building distributed systems, AI pipelines, and full-stack applications. Proficient in Java, Python, and JavaScript, with practical exposure to frameworks and tools such as LangChain, LangGraph, FastAPI, and cloud infrastructure through Internship and project work.",
  skills: {
    Languages: [
      "Java",
      "Python",
  ...
  projects: [
    {
      ...
      description:
        "Architected a Multi-Agent RAG System using LangGraph, orchestrating a specialized Generator Agent (LLM) and a Discriminator Agent to validate responses, significantly reducing hallucination rates and enabling web-based precedent matching for enhanced legal research.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Engineered a high-concurrency ticket booking platform solving the double-booking race condition via pessimistic locking, validated under 500+ concurrent transactions with zero data inconsistencies.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Developed a low-latency 1-to-1 real-time chat system using raw TCP sockets, bypassing HTTP overhead for persistent bidirectional communication with PostgreSQL-backed message persistence.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Built an IoT system to monitor tank water levels and automate motor control using an ESP32, ultrasonic sensor, and relay, with MQTT for real-time data and a React frontend for mobile monitoring and manual override.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Designed and developed a personal technical journal to document daily learning, with client-side routing and production deployment on Vercel.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Developed a cross-platform offline-first habit tracker with habit creation, progress tracking, visual analytics, and data import/export via URL.",
      bullets: [
  ...
  achievements: [
    {
      ...
      description:
        "Solved 525+ problems (275+ Medium, 28+ Hard) with a contest rating of 1,848.",
      highlight: true,
    },
    {
      title: "GATE 2026 Qualified",
      description:
        "Scored 510 in GATE 2026, securing AIR 6956 out of 211,020 applicants (top 3.3%).",
      highlight: true,
    },
    {
      title: "Event Organizer – Interrupt '25",
      description:
        "Organized a department-level paper presentation event and an Azure Data Engineering workshop at Interrupt '25.",
      highlight: false,
    },
    {
      title: "Udemy – Full-Stack Web Development Bootcamp",
      description:
        "Completed a comprehensive full-stack web development bootcamp, gaining hands-on experience in building end-to-end web applications.",
      highlight: false,
    },
  ],
  education: [
